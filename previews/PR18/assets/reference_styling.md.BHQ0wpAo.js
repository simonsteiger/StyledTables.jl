...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> StyledTable</span></span></code></pre></div><p>Set global rounding options for all numeric cells.</p><p>Options pass to <code>SummaryTables.Table</code> at render time. Per-column formatters (see <a href="/StyledTables.jl/previews/PR18/reference/formatting#fmt_number!"><code>fmt_number!</code></a>, <a href="/StyledTables.jl/previews/PR18/reference/formatting#fmt!"><code>fmt!</code></a>) take precedence.</p><p><strong>Arguments</strong></p><ul><li><code>tbl</code>: the <a href="/StyledTables.jl/previews/PR18/resources/api#StyledTables.StyledTable"><code>StyledTable</code></a> to modify.</li></ul><p><strong>Keywords</strong></p><ul><li><p><code>round_digits</code>: number of digits to round to.</p></li><li><p><code>round_mode</code>: <code>:auto</code>, <code>:digits</code>, or <code>:sigdigits</code>.</p></li><li><p><code>trailing_zeros</code>: whether to keep trailing zeros after rounding.</p></li></ul><p><strong>Returns</strong></p><p><code>tbl</code> (modified in place).</p><p>See also: <a href="/StyledTables.jl/previews/PR18/reference/formatting#fmt_number!"><code>fmt_number!</code></a>, <a href="/StyledTables.jl/previews/PR18/reference/formatting#fmt_percent!"><code>fmt_percent!</code></a>, <a href="/StyledTables.jl/previews/PR18/reference/formatting#fmt_integer!"><code>fmt_integer!</code></a>.</p><p><strong>Examples</strong></p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">tbl </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> StyledTable</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(df)</span></span>
