...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">tab_rowgroup!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:variable</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
...
</table></div><p>Row groups label the variable category, the stub column names each subgroup, and multiline headers identify each treatment arm and statistic type. The missing Placebo <code>Unknown</code> count appears as an em dash.</p>`,13)])])}const y=s(n,[["render",e]]);export{o as __pageData,y as default};
