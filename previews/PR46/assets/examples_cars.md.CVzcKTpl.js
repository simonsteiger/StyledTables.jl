import{_ as s,o as i,c as n,aA as e}from"./chunks/framework.BbYWnrLV.js";const y=JSON.parse('{"title":"Sports Cars Performance Table","description":"","frontmatter":{},"headers":[],"relativePath":"examples/cars.md","filePath":"examples/cars.md","lastUpdated":null}'),l={name:"examples/cars.md"};function a(d,t,h,r,p,g){return i(),n("div",null,[...t[0]||(t[0]=[e(`<h1 id="Sports-Cars-Performance-Table" tabindex="-1">Sports Cars Performance Table <a class="header-anchor" href="#Sports-Cars-Performance-Table" aria-label="Permalink to &quot;Sports Cars Performance Table {#Sports-Cars-Performance-Table}&quot;">​</a></h1><p>This example creates a table comparing sports cars across performance metrics.</p><p>Styling elements used in this example are:</p><ul><li><p>Rowgroups</p></li><li><p>Hidden columns</p></li><li><p>Column labels</p></li><li><p>Formatting values</p></li><li><p>Column spanners</p></li><li><p>Cell alignment</p></li><li><p>Cell styling (bold font)</p></li><li><p>Footnotes</p></li><li><p>Source notes</p></li></ul><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> StyledTables, DataFrames</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">rowgroup!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:origin</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">hide!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:origin</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:year</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div><div class="vp-raw-html"><table id="st-f732419d">
    <style>
        #st-f732419d {
            border: none;
            margin: 0 auto;
    ...
    <tr><td colspan="6" style="border-bottom: 1.5px solid currentColor; padding: 0"></td></tr>
</table></div><h2 id="Step-2:-Add-a-spanner-for-performance-metrics" tabindex="-1">Step 2: Add a spanner for performance metrics <a class="header-anchor" href="#Step-2:-Add-a-spanner-for-performance-metrics" aria-label="Permalink to &quot;Step 2: Add a spanner for performance metrics {#Step-2:-Add-a-spanner-for-performance-metrics}&quot;">​</a></h2><p>The columns <code>hp</code>, <code>trq_nm</code>, and <code>mpg</code> all describe performance of cars. Let&#39;s unite them under a Performance column spanner:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">spanner!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, [</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:hp</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:trq_nm</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:mpg</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">] </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;Performance&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div><div class="vp-raw-html"><table id="st-18fe56da">
    <style>
        #st-18fe56da {
            border: none;
            margin: 0 auto;
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div><div class="vp-raw-html"><table id="st-0410cd54">
    <style>
        #st-0410cd54 {
            border: none;
            margin: 0 auto;
...
</table></div>`,18)])])}const o=s(l,[["render",a]]);export{y as __pageData,o as default};
