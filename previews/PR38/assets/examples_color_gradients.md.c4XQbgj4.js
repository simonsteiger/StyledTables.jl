...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div><div><table id="st-9bc7fbd4">
    <style>
        #st-9bc7fbd4 {
            border: none;
            margin: 0 auto;
    ...
    <tr><td colspan="2" style="border-bottom: 1.5px solid currentColor; padding: 0"></td></tr>
</table></div><h2 id="Step-3:-Column-labels" tabindex="-1">Step 3: Column labels <a class="header-anchor" href="#Step-3:-Column-labels" aria-label="Permalink to &quot;Step 3: Column labels {#Step-3:-Column-labels}&quot;">​</a></h2><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>cols_label!(tbl, :id =&gt; &quot;Student ID&quot;, :score =&gt; &quot;Score&quot;)</span></span>
<span class="line"><span>render(tbl)</span></span></code></pre></div>`,19)])])}const y=s(n,[["render",h]]);export{c as __pageData,y as default};
