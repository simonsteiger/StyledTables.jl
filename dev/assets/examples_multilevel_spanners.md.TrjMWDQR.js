import{_ as e,o as l,c as s,aA as i}from"./chunks/framework.DeH5H0ZK.js";const y=JSON.parse('{"title":"Multi-tier spanners","description":"","frontmatter":{},"headers":[],"relativePath":"examples/multilevel_spanners.md","filePath":"examples/multilevel_spanners.md","lastUpdated":null}'),n={name:"examples/multilevel_spanners.md"};function a(d,t,h,r,g,p){return l(),s("div",null,[...t[0]||(t[0]=[i(`<h1 id="Multi-tier-spanners" tabindex="-1">Multi-tier spanners <a class="header-anchor" href="#Multi-tier-spanners" aria-label="Permalink to &quot;Multi-tier spanners {#Multi-tier-spanners}&quot;">​</a></h1><p>The following example shows how you can create layouts with several tiers of column spanners.</p><p>We will use the <a href="https://allisonhorst.github.io/palmerpenguins/" target="_blank" rel="noreferrer"><code>PalmerPenguins</code></a> data.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> DataFrames, Chain, StyledTables</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><div class="vp-raw-html"><div><div style = "float: left;"><span>5×8 DataFrame</span></div><div style = "clear: both;"></div></div><div class = "data-frame" style = "overflow-x: scroll;"><table class = "data-frame" style = "margin-bottom: 6px;"><thead><tr class = "columnLabelRow"><th class = "stubheadLabel" style = "font-weight: bold; text-align: right;">Row</th><th style = "text-align: left;">island</th><th style = "text-align: left;">species</th><th style = "text-align: left;">male_bill_length_mm</th><th style = "text-align: left;">male_bill_depth_mm</th><th style = "text-align: left;">male_flipper_length_mm</th><th style = "text-align: left;">female_bill_length_mm</th><th style = "text-align: left;">female_bill_depth_mm</th><th style = "text-align: left;">female_flipper_length_mm</th></tr><tr class = "columnLabelRow"><th class = "stubheadLabel" style = "font-weight: bold; text-align: right;"></th><th title = "String" style = "text-align: left;">String</th><th title = "String" style = "text-align: left;">String</th><th title = "Union{Missing, Float64}" style = "text-align: left;">Float64?</th><th title = "Union{Missing, Float64}" style = "text-align: left;">Float64?</th><th title = "Union{Missing, Float64}" style = "text-align: left;">Float64?</th><th title = "Union{Missing, Float64}" style = "text-align: left;">Float64?</th><th title = "Union{Missing, Float64}" style = "text-align: left;">Float64?</th><th title = "Union{Missing, Float64}" style = "text-align: left;">Float64?</th></tr></thead><tbody><tr class = "dataRow"><td class = "rowLabel" style = "font-weight: bold; text-align: right;">1</td><td style = "text-align: left;">Biscoe Is.</td><td style = "text-align: left;">Adelie</td><td style = "text-align: right;">40.5909</td><td style = "text-align: right;">19.0364</td><td style = "text-align: right;">190.409</td><td style = "text-align: right;">37.3591</td><td style = "text-align: right;">17.7045</td><td style = "text-align: right;">187.182</td></tr><tr class = "dataRow"><td class = "rowLabel" style = "font-weight: bold; text-align: right;">2</td><td style = "text-align: left;">Biscoe Is.</td><td style = "text-align: left;">Gentoo</td><td style = "text-align: right;">49.4738</td><td style = "text-align: right;">15.718</td><td style = "text-align: right;">221.541</td><td style = "text-align: right;">45.5638</td><td style = "text-align: right;">14.2379</td><td style = "text-align: right;">212.707</td></tr><tr class = "dataRow"><td class = "rowLabel" style = "font-weight: bold; text-align: right;">3</td><td style = "text-align: left;">Dream Is.</td><td style = "text-align: left;">Adelie</td><td style = "text-align: right;">40.0714</td><td style = "text-align: right;">18.8393</td><td style = "text-align: right;">191.929</td><td style = "text-align: right;">36.9111</td><td style = "text-align: right;">17.6185</td><td style = "text-align: right;">187.852</td></tr><tr class = "dataRow"><td class = "rowLabel" style = "font-weight: bold; text-align: right;">4</td><td style = "text-align: left;">Dream Is.</td><td style = "text-align: left;">Chinstrap</td><td style = "text-align: right;">51.0941</td><td style = "text-align: right;">19.2529</td><td style = "text-align: right;">199.912</td><td style = "text-align: right;">46.5735</td><td style = "text-align: right;">17.5882</td><td style = "text-align: right;">191.735</td></tr><tr class = "dataRow"><td class = "rowLabel" style = "font-weight: bold; text-align: right;">5</td><td style = "text-align: left;">Torgersen Is.</td><td style = "text-align: left;">Adelie</td><td style = "text-align: right;">40.587</td><td style = "text-align: right;">19.3913</td><td style = "text-align: right;">194.913</td><td style = "text-align: right;">37.5542</td><td style = "text-align: right;">17.55</td><td style = "text-align: right;">188.292</td></tr></tbody></table></div></div><p>The table we want to create will feature island as the row group, and the species present on each island are listed in each group. As some of the length measurements we summarised describe the bill, we will group these as a column spanner. Finally, a higher-order column spanner will indicate which measurements are from female and which from male penguins.</p><h2 id="Step-1:-Row-groups" tabindex="-1">Step 1: Row groups <a class="header-anchor" href="#Step-1:-Row-groups" aria-label="Permalink to &quot;Step 1: Row groups {#Step-1:-Row-groups}&quot;">​</a></h2><p>We begin by setting row groups and hiding the grouping column:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">tbl </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> StyledTable</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(summary)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">rowgroup!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:island</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">hide!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:island</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div><div class="vp-raw-html"><table id="st-bbd0a04f">
    <style>
        #st-bbd0a04f {
            border: none;
            margin: 0 auto;
    ...
    <tr><td colspan="7" style="border-bottom: 1.5px solid currentColor; padding: 0"></td></tr>
</table></div><h2 id="Step-2:-Level-one-spanner" tabindex="-1">Step 2: Level one spanner <a class="header-anchor" href="#Step-2:-Level-one-spanner" aria-label="Permalink to &quot;Step 2: Level one spanner {#Step-2:-Level-one-spanner}&quot;">​</a></h2><p>Next, we add the level one spanner, grouping all columns with bill measures together:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">spanner!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;male_&quot;</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> .*</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> string</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.(bill_cols) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;Bill measures&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">spanner!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;female_&quot;</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> .*</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> string</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.(bill_cols) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;Bill measures&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div><div class="vp-raw-html"><table id="st-97bf0bbf">
    <style>
        #st-97bf0bbf {
            border: none;
            margin: 0 auto;
    ...
    <tr><td colspan="7" style="border-bottom: 1.5px solid currentColor; padding: 0"></td></tr>
</table></div><h2 id="Step-3:-Level-two-spanner" tabindex="-1">Step 3: Level two spanner <a class="header-anchor" href="#Step-3:-Level-two-spanner" aria-label="Permalink to &quot;Step 3: Level two spanner {#Step-3:-Level-two-spanner}&quot;">​</a></h2><p>On top of the level one spanner, we&#39;ll add a spanner grouping columns of males and females together:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">spanner!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, male_ordered </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;Male&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">; level </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 2</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">spanner!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, female_ordered </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;Female&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">; level </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 2</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div><div class="vp-raw-html"><table id="st-5a66a378">
    <style>
        #st-5a66a378 {
            border: none;
            margin: 0 auto;
    ...
    <tr><td colspan="7" style="border-bottom: 1.5px solid currentColor; padding: 0"></td></tr>
</table></div><h2 id="Step-4:-Add-column-labels" tabindex="-1">Step 4: Add column labels <a class="header-anchor" href="#Step-4:-Add-column-labels" aria-label="Permalink to &quot;Step 4: Add column labels {#Step-4:-Add-column-labels}&quot;">​</a></h2><p>Now we can simplify the names of the columns because the information about bill measures and sex is contained in our column spanners:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">label_dict </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> Dict</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">format!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">IntegerFormatter</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">([male_ordered</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">...</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, female_ordered</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">...</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]))</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div><div class="vp-raw-html"><table id="st-fcdeb69b">
    <style>
        #st-fcdeb69b {
            border: none;
            margin: 0 auto;
    ...
    <tr><td colspan="7" style="border-bottom: 1.5px solid currentColor; padding: 0"></td></tr>
</table></div>`,25)])])}const o=e(n,[["render",a]]);export{y as __pageData,o as default};
