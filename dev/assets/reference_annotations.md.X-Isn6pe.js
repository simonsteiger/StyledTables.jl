...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> StyledTable</span></span></code></pre></div><p>Add a title and optional subtitle above the column headers.</p><p>The title renders bold; the subtitle renders italic.</p><p><strong>Arguments</strong></p><ul><li><p><code>tbl</code>: the <a href="/StyledTables.jl/dev/resources/api#StyledTables.StyledTable"><code>StyledTable</code></a> to modify.</p></li><li><p><code>title</code>: main heading text.</p></li></ul><p><strong>Keywords</strong></p><ul><li><p><code>subtitle</code>: secondary heading text, or <code>nothing</code> (default).</p></li><li><p><code>align</code>: horizontal alignment (<code>:left</code>, <code>:center</code>, <code>:right</code>), default <code>:center</code>.</p></li></ul><p><strong>Returns</strong></p><p><code>tbl</code> (modified in place).</p><p>See also: <a href="/StyledTables.jl/dev/reference/structure#StyledTables.spanner!-Tuple{StyledTable, Vararg{Pair}}"><code>spanner!</code></a>, <a href="/StyledTables.jl/dev/reference/annotations#StyledTables.sourcenote!"><code>sourcenote!</code></a>, <a href="/StyledTables.jl/dev/reference/annotations#StyledTables.footnote!-Tuple{StyledTable, Vararg{Pair}}"><code>footnote!</code></a>.</p><p><strong>Examples</strong></p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">tbl </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> StyledTable</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(df)</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div>`,12)),n(i,{type:"info",class:"source-link",text:"source"},{default:l(()=>[...s[2]||(s[2]=[t("a",{href:"https://github.com/simonsteiger/StyledTables.jl/blob/95116dad97f9107baa1e49e148461ef328aae8c5/src/annotations.jl#L1",target:"_blank",rel:"noreferrer"},"source",-1)])]),_:1})]),s[13]||(s[13]=a(`<h2 id="footnote!" tabindex="-1"><code>footnote!</code> <a class="header-anchor" href="#footnote!" aria-label="Permalink to &quot;\`footnote!\` {#footnote!}&quot;">​</a></h2><p>Attach footnotes to columns, spanners, or individual body cells. An superscript marks the target; the annotation text appears below the table. For general notes, use <a href="/StyledTables.jl/dev/reference/annotations#StyledTables.sourcenote!"><code>sourcenote!</code></a>.</p><p><strong>Signatures:</strong></p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">footnote!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, col </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> text)</span></span>
