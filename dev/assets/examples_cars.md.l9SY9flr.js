...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">render</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl)</span></span></code></pre></div><div><table id="st-18fe56da">
    ...
    <tr><td colspan="6" style="border-bottom: 1.5px solid currentColor; padding: 0"></td></tr>
</table></div><h2 id="Step-3:-Reorder,-format,-and-highlight" tabindex="-1">Step 3: Reorder, format, and highlight <a class="header-anchor" href="#Step-3:-Reorder,-format,-and-highlight" aria-label="Permalink to &quot;Step 3: Reorder, format, and highlight {#Step-3:-Reorder,-format,-and-highlight}&quot;">​</a></h2><p>Move MSRP next to the model name, format it with a currency prefix, right-align the numeric columns, bold the price values, and add an annotated footnote on MPG.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">fmt!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(tbl, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:msrp_eur</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span></span>
