...
</table></div><p>The final table presents demographic data in the standard clinical format: row groups label the variable category, the stub column names the subgroup, and multiline column headers identify each treatment arm and statistic type. The missing <code>Unknown</code> count in the Placebo arm is replaced with an em dash by <code>sub_missing</code>.</p>`,13)])])}const E=s(l,[["render",e]]);export{o as __pageData,E as default};
