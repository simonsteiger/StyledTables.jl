...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    italic,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    underline</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> StyledTable</span></span></code></pre></div><p>Apply inline styling to all body cells in the specified columns.</p><p>Any keyword left as <code>nothing</code> is inherited from the cell default.</p><p><strong>Arguments</strong></p><ul><li><p><code>tbl</code>: the <a href="/StyledTables.jl/dev/resources/api#StyledTables.StyledTable"><code>StyledTable</code></a> to modify.</p></li><li><p><code>columns</code>: column names to style.</p></li></ul><p><strong>Keywords</strong></p><ul><li><p><code>color</code>: color value — hex string (<code>&quot;#RRGGBB&quot;</code>), CSS name (<code>&quot;green&quot;</code>), symbol (<code>:green</code>), or a <code>Colors.Colorant</code>. <code>nothing</code> inherits the default. Alpha channels are silently dropped.</p></li><li><p><code>bold</code>: <code>true</code>/<code>false</code>, or <code>nothing</code>.</p></li><li><p><code>italic</code>: <code>true</code>/<code>false</code>, or <code>nothing</code>.</p></li><li><p><code>underline</code>: <code>true</code>/<code>false</code>, or <code>nothing</code>.</p></li></ul><p><strong>Returns</strong></p><p><code>tbl</code> (modified in place).</p><p>See also: <a href="/StyledTables.jl/dev/reference/formatting#format!"><code>format!</code></a>, <a href="/StyledTables.jl/dev/reference/modifiers#align!"><code>align!</code></a>.</p><p><strong>Examples</strong></p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">tbl </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> StyledTable</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(df)</span></span>
